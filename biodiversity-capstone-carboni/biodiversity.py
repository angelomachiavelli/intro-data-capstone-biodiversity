...
con_status_values = species.conservation_status.unique()
print(con_status_values)
...
con_status_counts = species.scientific_name.groupby(species.conservation_status).count().reset_index()
print(con_status_counts)
...
con_status_counts = species.groupby(species.conservation_status).scientific_name.count().reset_index()
print(con_status_counts)
...
plt.savefig('conservation-status-by-species.jpg')
plt.show()
...
contingency2 = [[38, 176],
                [5, 74]]
chi2_2, pval2, dof2, expected2 = chi2_contingency(contingency2)
print(pval2)
...
print(species[species.is_sheep == True].reset_index())
...
sheep_observations = pd.merge(sheep_species, observations, how='inner', on='scientific_name')
...
plt.savefig('observations-of-sheep-per-week.jpg')
plt.show()
...
'''Bryce = 250 / 520. Just over two weeks.
Yellowstone = 507 / 520. Just over a week.'''
